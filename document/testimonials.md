...
### Create (full payload)
Use this payload when creating a testimonial (all fields shown). Omit fields you do not have — DB defaults will be applied where configured.
...
{ "success": true, "message": "Testimonial updated" }
```
